...
The markdown of the present paper and all code for reproducibility of results is available on GitHub at [https://github.com/psicostat/clustersimulation](https://github.com/psicostat/clustersimulation){target="_blank"} 
